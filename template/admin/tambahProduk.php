  ...
  <div class='ui grid'>
    ...
    <div class='five wide column'>
              ...
              <div class="ui dimmer">
                <div class="content">
                  <div class="center">
                    ...
                    <input name='gambar_utama' id='inputFoto' type='file' required style='display:none;'/>
                  </div>
                </div>
              </div>
      ...
      <div class='field'>
        ...
        <div id='tambah-gambar' style='margin-bottom:10px;background:#E91E63;color:#fff;padding:5px 10px;display:inline-block;cursor:pointer;'>Tambah Gambar</div>
      </div>
      <div class='field'>
